  ...
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        ETERNAL PREEMINENCE is revolutionizing the technological concept of
        industrial businesses majorly in Solid Minerals trading, Engineering
        Technology, Agriculture and Logistics.
      </p>
